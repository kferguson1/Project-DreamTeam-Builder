...
var slotsAr = [
  ...
  localStorage.getItem("slot6"),
];
var slotsArImg = [
  localStorage.getItem("slot1img"),
  localStorage.getItem("slot2img"),
  localStorage.getItem("slot3img"),
  localStorage.getItem("slot4img"),
  localStorage.getItem("slot5img"),
  localStorage.getItem("slot6img"),
];
console.log(slotsAr);

function displayTeamF() {
  for (i = 0; i < slotsAr.length; i++) {
    var teamDiv = $("<div class='innerSlot'>");
    var teamNameEl = $("<p class='teamName'>").text(slotsAr[i]);
    var teamImgEl = $("<img class='teamImg'>").attr("src", slotsArImg[i]);
    var slot;
